...
const RoomService_lists_args = class {
    constructor(args) {}
    ...
    write(output) {
        output.writeStructBegin('RoomService_lists_args');
        output.writeFieldStop();
        output.writeStructEnd();
        return;
    }
};
const RoomService_lists_result = class {
    constructor(args) {
        this.success = null;
        if (args) {
            if (args.success !== undefined && args.success !== null) {
                this.success = Thrift.copyList(args.success, [ttypes.RoomInfo]);
            }
        }
    }
    ...
    write(output) {
        output.writeStructBegin('RoomService_lists_result');
        if (this.success !== null && this.success !== undefined) {
...
const RoomServiceClient = (exports.Client = class RoomServiceClient {
    ...
    send_lists() {
        const output = new this.pClass(this.output);
        const args = new RoomService_lists_args();
        try {
            output.writeMessageBegin('lists', Thrift.MessageType.CALL, this.seqid());
            args.write(output);
            output.writeMessageEnd();
            return this.output.flush();
        } catch (e) {
    ...
    recv_lists(input, mtype, rseqid) {
        ...
        const result = new RoomService_lists_result();
        result.read(input);
        input.readMessageEnd();
        ...
        return callback('lists failed: unknown result');
    }
...
const RoomServiceProcessor = (exports.Processor = class RoomServiceProcessor {
    ...
    process_create(seqid, input, output) {
        ...
        if (this._handler.create.length === 0) {
            new Promise((resolve) => resolve(this._handler.create.bind(this._handler)()))
                .then((result) => {
    ...
    process_get(seqid, input, output) {
        ...
        if (this._handler.get.length === 1) {
            new Promise((resolve) => resolve(this._handler.get.bind(this._handler)(args.id)))
                .then((result) => {
    ...
    process_lists(seqid, input, output) {
        const args = new RoomService_lists_args();
        args.read(input);
        input.readMessageEnd();
        if (this._handler.lists.length === 0) {
            new Promise((resolve) => resolve(this._handler.lists.bind(this._handler)()))
                .then((result) => {
                    const result_obj = new RoomService_lists_result({ success: result });
                    output.writeMessageBegin('lists', Thrift.MessageType.REPLY, seqid);
                    result_obj.write(output);
                    output.writeMessageEnd();
                    output.flush();
                })
                .catch((err) => {
                    let result;
                    result = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
                    output.writeMessageBegin('lists', Thrift.MessageType.EXCEPTION, seqid);
                    result.write(output);
                    output.writeMessageEnd();
                    output.flush();
                });
        } else {
            this._handler.lists((err, result) => {
                let result_obj;
                if (err === null || typeof err === 'undefined') {
                    result_obj = new RoomService_lists_result(
                        err !== null || typeof err === 'undefined' ? err : { success: result },
                    );
                    output.writeMessageBegin('lists', Thrift.MessageType.REPLY, seqid);
                } else {
    ...
    process_pppbool(seqid, input, output) {
        ...
        if (this._handler.pppbool.length === 1) {
            new Promise((resolve) => resolve(this._handler.pppbool.bind(this._handler)(args.id)))
                .then((result) => {
